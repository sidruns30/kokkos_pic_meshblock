...
auto main(int argc, char* argv[]) -> int
{
  ...
  Kokkos::initialize(argc, argv);
  {
    ...
    InitializeParticleArrays(nparticles, myMeshBlock, tag_arr, x_arr, y_arr,
                              z_arr, vx_arr, vy_arr, vz_arr);
    PushParticles(nparticles, myMeshBlock, tag_arr, x_arr, y_arr,
                              z_arr, vx_arr, vy_arr, vz_arr, dt);
  ...
  /*
    Question: view is created on the cpu. Would accessing it on the gpu
              be a lot slower? 
  */
